  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="relative flex items-center gap-4 p-6 bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl opacity-60 cursor-not-allowed">
          ...
          <div className="text-left">
            <h4 className="font-semibold text-gray-500">Connect Bank</h4>
            <p className="text-sm text-gray-400">Coming soon</p>
          </div>
          <span className="absolute top-2 right-2 text-xs bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-full font-medium">Coming Soon</span>
        </div>
      </div>
    </div>
  );
