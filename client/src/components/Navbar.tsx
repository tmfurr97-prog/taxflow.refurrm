        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              className="bg-[#18453B] hover:bg-[#0D3328] text-gray-900 font-semibold px-6 py-2.5 rounded-lg text-sm transition-all duration-300 shadow-sm hover:shadow-md"
            >
              Get Started
            </button>
          ...
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="pt-3 border-t border-gray-100 space-y-2">
              ...
              <button
                ...
                className="w-full bg-[#18453B] hover:bg-[#0D3328] text-gray-900 font-semibold px-6 py-3 rounded-lg text-sm transition-colors"
              >
                Get Started
              </button>
