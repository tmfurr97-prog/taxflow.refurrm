...
const ADDONS = [
  ...
  { key: 'notarySession' as AlacarteKey, icon: Shield, title: 'Remote Online Notarization', desc: 'Get documents notarized from anywhere. Business formation, contracts, real estate & more.', price: '$50', badge: null, badgeColor: null, path: '/notary' },
